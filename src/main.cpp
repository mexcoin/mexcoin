...
uint256 hashGenesisBlock("0x14af7e35890ae993e91cf44ec7ea27f84ca8bf0ad6c10187b9b04a14f7440c86");
...
const string strMessageMagic = "mexcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // mexcoin: 1 days
static const int64 nTargetSpacing = 120; // mexcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mexcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "mexcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6d7e4ace1217b3d9c79a311930e6924bde7f8a18dc1a3aa1483cb80f61bf7ff4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Times 09/May/2014 Chancellor on brink of second bailout for banks";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401822582; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 5332227;

        if (fTestNet)
        {
            block.nTime    = 1398932880;
            block.nNonce   = 3627339;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa7b87f8a7a405122dac4a35e8880708844dfe37e0b0c415179c57c0a0a62d913"));
